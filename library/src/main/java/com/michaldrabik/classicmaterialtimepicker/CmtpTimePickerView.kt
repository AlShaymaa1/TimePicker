...
class CmtpTimePickerView @JvmOverloads constructor(
  ...
  private fun setupRecyclers() {
    ...
    setupRecyclersData(4,10)
  }

  private fun setupRecyclersData(firstNum:Int,secondNum:Int) {
//    val hours = when (time.getType()) {
//      HOUR_12 ->
//      {
//        CmtpTimeData.HOURS_12
//      }
//
//      HOUR_24 -> CmtpTimeData.HOURS_24
//    }
    val hours=(firstNum..secondNum)
    cmtpRecyclerHours.apply {
   ...
   */
  fun setTime(initialTime: CmtpTime,x:Int ,y:Int) {
    time = initialTime
    setupRecyclersData(x,y)
  }
